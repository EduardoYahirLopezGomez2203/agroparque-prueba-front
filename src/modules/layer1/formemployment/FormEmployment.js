...
import useEmploymentCreate from "./useEmploymentCreate";
import { useState, useEffect } from "react";

const FormEmployment = ({ updateData, setUpdateData, isUpdate, setIsUpdate, setUpdate, responseUpdate }) => {
    const { handleCreate, datos } = useEmploymentCreate();
