...
import useTypeOfEmployeeCreate from "./useTypeOfEmployeeCreate";
import { useState,useEffect } from "react";

const FormTypeOfEmployee = ({ updateData, setUpdateData, isUpdate, setIsUpdate, setUpdate, responseUpdate}) => {
    const { handleCreate, datos } = useTypeOfEmployeeCreate();
...
export default FormTypeOfEmployee;